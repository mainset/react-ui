...
function createOverlayBasicComponent(_ref2) {
  ...
  function (_Component) {
    ...
    function OverlayBasicComponent(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(OverlayBasicComponent).call(this, props)); // this.overlayRoot = window && window.document.getElementById(`${BASIC_CLASS_NAME}-root`);
    ...
    _createClass(OverlayBasicComponent, [{
      ...
      value: function componentDidMount() {
        ...
        this.overlayRoot = window && window.document.getElementById("".concat(BASIC_CLASS_NAME, "-root"));
